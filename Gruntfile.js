...
module.exports = function(grunt) {
  ...
  var protractorDir = 'node_modules\\.bin\\';
  ...
  grunt.initConfig({
    ...
    protractor_webdriver: {
      alive: {
        options: {
          path: "node_modules\\protractor\\node_modules\\webdriver-manager\\bin\\",//protractorDir"",
          keepAlive: true
        }
      },
      dead: {
    ...
    shell: {
      ...
      serverForTesting: {
        ...
        command: 'node_modules\\.bin\\http-server . -p 8899'
      },
      server: {
        options: {
          stdout: true,
        ...
        command: 'node_modules\\.bin\\http-server . -p 8282'
      },
      ls: {
        options: {
          stdout: true
